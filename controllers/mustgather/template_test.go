...
func Test_getGatherContainer(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			container := getGatherContainer(tt.audit, tt.timeout, tt.storage, tt.caConfigMap, tt.timeFilter, tt.clusterCreation)
...
func Test_getJobTemplate_ProxyAuditTimeout(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			job := getJobTemplate("operator-image", mg, "", nil)
